<?php
namespace common\widgets\single_uploader;
...
//            $this->upBase64();
    ...
    private function upBase64()
    {
        ...
        $this->fileType = $this->getFileExt();
        $this->fullName = $this->getFullName();
        $this->filePath = $this->getFilePath().'.'.$this->oriName;
        $this->fileName = $this->getFileName().'.'.$this->oriName;
        $dirname = dirname($this->filePath);
        //检查文件大小是否超出限制
        if (!$this->checkSize()) {
            $this->stateInfo = $this->getStateInfo("ERROR_SIZE_EXCEED");
