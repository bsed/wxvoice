  ...
  Cropper.prototype = {
    ...
    init: function () {
      ...
      if ($this.is('img')) {
        ...
        // Should use `$.fn.attr` here. e.g.: "images/picture.jpg"
        ...
        // Should use `$.fn.prop` here. e.g.: "http://example.com/images/picture.jpg"
        url = $this.prop('src');
    ...
    initCropBox: function () {
	  ...
	  cropBox.width = containerWidth*autoCropArea;
	  cropBox.height = cropBox.width/aspectRatio;
