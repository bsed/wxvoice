...
//创建评论框
function CreatePLHtml(){
	var plHtml= '<div class="bg-white b-t-greyf1 comment-edit-box" id="commentEdit">'+
				'<div class="m-comment-edit bc-grey">' +
				'	<div class="m-comment-textarea fs30" contenteditable="plaintext-only"></div>' +
				'</div>'+
				'<span class="u-issue-comment fs28 fc-white bg-red">发送</span>'+
				'</div>';
	return plHtml;
}
