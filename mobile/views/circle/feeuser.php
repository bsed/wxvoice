            ...
            <div class="circle-share-detail">
                ...
                <div class="csd-head">
                    ...
                    <div class="csd-head-body">
                        <i class="mt30">
                            <img src="<?=Yii::$app->params['public'];?><?=$feeUser['logo'];?>">
                        </i>
                ...
                <div class="csd-brief bg-white">
                    ...
                    <div class="csd-brief-join">
                        ...
                        <p class="fs26 mt10" id="joinSummary">付款成功后，您可以在<span><?=date('Y年m月d日',time());?>至<?=date('Y年m月d日',strtotime('+1 year'));?></span>收听、查看相关内容 </p>
                    </div>
                </div>
