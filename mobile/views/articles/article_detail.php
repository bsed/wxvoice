...
<div id="container" class="container article-container bg-greyfa">
    <div id="page">
        ...
        <div class="page__bd">
                    ...
                    <?php endif;?>
                        <div class="author-focus-time-read bg-greyfa">
                            <div class="author-focus fs24">
                                <a class="mr5" onclick="gotoUser_pageHtml(<?=$info['member_id']?>)">
                                    <img src="<?=Yii::$app->params['public'].'/attachment'.$info['user']['photo']?>"><i>
                                        <img src="../bdt/images/v2.png"></i></a><div>
                                    <a class="fc-navy" onclick="gotoUser_pageHtml(<?=$info['member_id']?>)"><?=$info["user"]['nickname']?></a>
                                    <?php if($info['member_id'] != $member_id):?>
            ...
            <?php if($info['circle_id'] ==0):?>
           <!--推荐问答-->
            <div class="recommend-qanda mt10" id="answerQaList" style="display:none">
    ...
    <div class="appui-mask"></div><div class="appui-helptext bg-white" id="helptext" style="display:none;">
        ...
        <div class="appui-helptext-bd fc-black456 b-b-grey">
            <div class="appui-helptext-bd-con fc-black">
                ...
                <!-- 		<p class="fs30 mb10">5、若问答被连续二次分享，通过连续二次分享页面进入且付费收听而产生的收益，二次分享者获得<span id="lv2ShareListenShare">0</span>元，提问者、回答者与一次分享者均获得<span id="lv2ShareListenQA">0</span>元；</p> --><p class="fs30 mb10">5、所有收入扣除<span id="qaFeeRate">0</span>作为平台佣金。账户余额大于<span id="minPayCash">0</span>元，每日21点系统自动将账户里的余额划到微信钱包内，用户也可前往“半导体吧”公众号提现；</p><p class="fs30 mb10">6、备注：免费围观券收听，行家、提问者、分享者都没有收益。</p></div></div>
