...
class UserController extends \yii\web\Controller
{
    public function actions()
    {
        ...
        return [
            ...
            'upload'=>[
                'class' => 'common\widgets\single_upload\UploadAction',     //这里扩展地址别写错
                'config' => [
                    'imagePathFormat' => "/avatar/{yyyy}{mm}{dd}/{time}{rand:6}",
                ]
            ],
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->logo = $post['filename']["imgpath_0"];
            $model->save();
    ...
    public function actionUpdate(){
        ...
        if ($model1->load(Yii::$app->request->post())) {
            ...
            if(!empty($post['User']['auth_key_new'])){
                $model1->logo = $post['filename']["imgpath_0"];
