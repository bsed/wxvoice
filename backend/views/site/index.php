                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" style="width: 64px;height: 64px;" src="<?=Yii::$app->params['public'].'/attachment'.$logo?>" /></span>
...
<!--                        </form>-->
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2016-2017 <a href="http://wpa.qq.com/msgrd?v=3&uin=896792616&site=qq&menu=yes" target="_blank">技术支持</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
