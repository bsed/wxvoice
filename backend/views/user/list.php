                            ...
                            <?php foreach($user as $vo):?>
                                <tr>
                                    ...
                                    <td><?=$vo['usergroup']['item_name']?></td>
                                        <td>
										<a class="btn btn-primary btn-xs" href="<?=Url::toRoute(['user/update','item_name'=>$vo['usergroup']['item_name'],'id'=>$vo['id']])?>">
										<i class="fa fa-edit"></i>编辑</a>  
										<?php if($vo['username'] !='admin'):?>
										<a href="<?=Url::toRoute(['user/delete','id'=>$vo['id']])?>" class="btn btn-default btn-xs">
